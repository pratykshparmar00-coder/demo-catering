      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[2.8rem] font-serif tracking-tight text-rc-charcoal font-light leading-[1.1]">
            ...
            <span className="italic font-normal">Demand</span> the Best
          </h2>
        </motion.div>
        ...
        >
          {TESTIMONIALS.map((t) => (
            <motion.div
              ...
              className="bg-white rounded-2xl border border-rc-border p-7 sm:p-8 space-y-5 flex flex-col hover:border-rc-forest/20 hover:shadow-[0_12px_40px_-12px_rgba(27,58,45,0.08)] transition-all duration-500"
            >
              {/* Quote icon */}
              <div className="w-10 h-10 rounded-xl bg-rc-forest/[0.06] flex items-center justify-center">
              ...
              <div className="pt-5 border-t border-rc-borderLight">
                ...
                <div className="text-[10px] text-rc-textMuted tracking-wider uppercase mt-2">
                  {t.event}
                </div>
              </div>
            </motion.div>
